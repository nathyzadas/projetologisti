...
if (isset($_POST['entrar'])) {
    ...
    //Se Digitou
        ...
        if ($row == 1) {
            ...
            //tratando caracteres e previnindo SQL injection.
            $usuario = mysqli_real_escape_string($conexao, $_POST["usuariofun"]);
            $senha = mysqli_real_escape_string($conexao, $_POST["senha"]);

            $query = "SELECT * from usuariofun where usuariofun ='$usuario' and senha = '" . md5($senha) . "'";
            ...
            if ($row == 1) {
                ...
                $_SESSION['usuariofun'] = $usuario;
                $_SESSION['bem_vindo'] = true;
                header("Location: ../viewfun/painel.php");
