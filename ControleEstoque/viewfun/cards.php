...
$sql_abaixo = "SELECT * FROM produto WHERE quantidade <50";
        ...
        <div class="row">
            ...
            <div class="card text-dark bg-outline-dark o-hidden h-100">
                    <div class="card-body">
                        ...
                        <p style="font-size:70%;">Produtos com quantidade inferior a : 50 unidades. </p>
                    </div>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                while ($dados_excesso = mysqli_fetch_array($result_excesso)) {
                                                    ...
                                                    echo  "<td>" .
                                                        "<a href='' style='cursor:pointer;' data-toggle='modal' data-target='#modal_saida'><img src='logo_branca_nova2.png' style='width:20%' class='media-object  img-responsive img-thumbnail'></a>"
