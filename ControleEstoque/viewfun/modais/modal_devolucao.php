...
<div class="modal fade bd-example-modal-lg" id="modal_devolucao" tabindex="-1" role="dialog" aria-labelledby="modal_devolucaoTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div style="background-color:#c79d33;" class="modal-header">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="lancar_devolucao" style="background-color:#c79d33;" class="btn btn cor"><div style="color:white">Lançar</div></button>
            </div>
            </form>
        </div>
    </div>
